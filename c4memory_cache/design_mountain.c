...
//当步长为 8、存储数据从 16K 到 512M 时，存储器的吞吐量；
#define MINBYTES (1 << 14)  /* First working set size */
#define MAXBYTES (1 << 29)  /* Last working set size,128M */

//当存储数据为 8M、步长从 1 到 15 时，存储器的吞吐量；
//#define MINBYTES (1 << 23)  /* First working set size */
//#define MAXBYTES (1 << 23)  /* Last working set size,128M */

#define MAXSTRIDE 8        /* Stride x8 bytes */
